  ...
  return (
    <>
      <div className='h-screen w-full flex items-center justify-center bg-slate-950'>
        ...
        {currentIndex !== 0 && (
          <div className='sm:relative absolute top-32 sm:w-[725px] w-96 min-h-[560px] max-h-fit sm:px-1 px-2 sm:mt-40 mt-0 sm:rounded-md rounded-none sm:pt-10 pt-7 pb-5 text-justify bg-slate-950 backdrop-blur-md overflow-y-auto over'>
            {renderTextShuffle()}
          </div>
        )}
      </div>
