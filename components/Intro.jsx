...
const Intro = () => {
  ...
  return (
    <>
      <div className='sm:h-screen min-h-screen w-full flex items-center justify-center overflow-hidden'>
        ...
        {currentIndex !== 0 && (
          <>
            <div className='absolute top-28 sm:top-24 w-full min-h-[560px] sm:h-[560px] max-h-fit sm:max-h-0 sm:px-1 px-3 sm:mt-40 mt-0 sm:rounded-md rounded-none sm:pt-10 pt-7 pb-5 text-justify bg-slate-950 backdrop-blur-md' />
            <div className='absolute top-28 sm:top-24 sm:w-[725px] w-[380px] min-h-[560px] sm:h-[560px] max-h-fit sm:max-h-0 sm:px-1 px-3 sm:mt-40 mt-0 sm:rounded-md rounded-none sm:pt-10 pt-7 pb-5 text-justify'>
              {renderTextShuffle()}
            </div>
          </>
        )}
